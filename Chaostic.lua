...
loadstring(game:HttpGet("https://raw.githubusercontent.com/ChaosticHub/Slap_Battles/main/Slap_Battles.lua"))()
    ]])
else
...
local OrionLib = loadstring(game:HttpGet(("https://raw.githubusercontent.com/Chaostic/Script/main/Orion_Library_PE_V2.lua")))()
local GameName = game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name
if game.PlaceId == 6403373529 or game.PlaceId == 9015014224 then
local Window = OrionLib:MakeWindow({IntroText = "Slap Battles ðŸ¤ž", IntroIcon = "rbxassetid://15315284749",Name = ("Chaostic Hub - Slap Battles ðŸ¤ž".." | ".. identifyexecutor()),IntroToggleIcon = "rbxassetid://7734091286", HidePremium = false, SaveConfig = false, IntroEnabled = true, ConfigFolder = "slap battles"})

-----Bypass-----

local Namecall
Namecall = hookmetamethod(game,"_____namecall_____",function(self,...)
...
Tab:AddParagraph("Zalo | Discord"," [ Zalo ]: Bn mun vào nhóm Zalo thì vào Credit nhé có link nhóm Zalo  ó | [ Discord ]: If you want to join the Server hack slap battles group, go to the credits section ] | Have Fun ;D")
...
Tab7:AddButton({
	...
	Callback = function()
if game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and if game.Players[_G.PlayerTeleport].Character:FindFirstChild("HumanoidRootPart") then
...
for i,v in pairs(game.Players:GetChildren()) do
if v ~= game.Players.LocalPlayer and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and v.Character then
if game.Players.LocalPlayer.Character:FindFirstChild("entered") and v.Character:FindFirstChild("entered") and v.Character:FindFirstChild("HumanoidRootPart") and v.Character.Ragdolled.Value == false then
if _G.AutoFarmKill == true then
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.Character:FindFirstChild("Head").CFrame
wait(0.25)
...
while _G.KillESP do
for i,v in ipairs(game.Players:GetChildren()) do
if v ~= game.Players.LocalPlayer and v.Character and v.Character:FindFirstChild("Head") and v.Head.Nametag.TextLabel.Text ~= v.Name then
...
if v.Character.Head:FindFirstChild("KillESP") and v.Character.Head.KillESP:FindFirstChild("TextLabel") and v.Character.Head.KillESP.TextLabel.Text ~= "Kill [ "..v.Head.Nametag.TextLabel.Text.." ]" then
v.Character.Head.KillESP.TextLabel.Text = "Kill [ "..v.Head.Nametag.TextLabel.Text.." ]"
else
v.Character.Head.KillESP.TextLabel.Text = "Kill [ No Kill ]"
end
if v.Character.Head:FindFirstChild("KillESP") == nil then
...
KillESPText.Text = "Kill [ "..v.Head.Nametag.TextLabel.Text.." ]"
                end
            end
            end
task.wait()
